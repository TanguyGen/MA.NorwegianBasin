...
Physics_template <- read.csv(stringr::str_glue("./StrathE2E/{implementation}/2010-2019-{ssp}/Driving/physics_CELTIC_SEA_2003-2013.csv"))  # Read in example Physical drivers
...
write.csv(Physics_new, 
          file = stringr::str_glue("./StrathE2E/{implementation}/2010-2019-{ssp}/Driving/physics_{toupper(implementation)}_{as.character(.x)}-{as.character(.y)}-{ssp}.csv"),
          row.names = F)
