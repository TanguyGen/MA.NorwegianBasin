...
S <- nrow(nc_lat)*(90+61)/180 ; N <- nrow(nc_lat)*(90+74)/180
W <- length(nc_lon)*(180-9)/360 ; E <- length(nc_lon)*(180+16)/360     # For Mercatore
...
mat %>%
  ...
  plot_3d(mat, zscale = 5, fov = 0, theta = 60, phi = 30, 
