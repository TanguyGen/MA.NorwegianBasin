...
#model <- e2e_read(implementation,"2010-2019", models.path = "StrathE2E/Norwegian_Basin_Mike", results.path = "StrathE2E/Results/")
#model <- e2e_read(implementation,str_glue("2010-2019-{ssp}"), models.path = "StrathE2E/Norwegian_Basin_Mike+Jack", results.path = "StrathE2E/Results/")
#model <- e2e_read("Norwegian_Basin_Share", str_glue("2010-2019-{ssp}"), models.path = "StrathE2E/", results.path = "StrathE2E/Results/")
