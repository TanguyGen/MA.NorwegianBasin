...
Events <- read.csv(stringr::str_glue("./Data/Norwegian_sea_Tanguy/Norwegian_sea/2010-2019/Param/event_timing_NORWEGIAN_BASIN_2010-2019.csv")) # Read in example Physical drivers
