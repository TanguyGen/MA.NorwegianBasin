...
unlink(stringr::str_glue("./StrathE2E/{implementation}/2010-2019/Driving/chemistry_NORWEGIAN_BASIN_2010-2019-ssp370.csv"))
unlink(stringr::str_glue("./StrathE2E/{implementation}/2010-2019/Param/physical_parameters_NORWEGIAN_BASIN.csv"))
unlink(stringr::str_glue("./StrathE2E/{implementation}/2010-2019/Driving/physics_NORWEGIAN_BASIN_2010-2019-ssp370.csv"))     # Delete old file
unlink(stringr::str_glue("./StrathE2E/{implementation}/2010-2019/Param/event_timing_NORWEGIAN_BASIN_2010-2019.csv"))

# unlink(stringr::str_glue("./StrathE2E/{implementation}/2010-2019/Param/fishing_fleet_CELTIC_SEA_2003-2013.csv"))
# unlink(stringr::str_glue("./StrathE2E/{implementation}/2010-2019/Param/fishing_activity_CELTIC_SEA_2003-2013.csv"))
# unlink(stringr::str_glue("./StrathE2E/{implementation}/2010-2019/Param/fishing_power_CELTIC_SEA.csv"))
# unlink(stringr::str_glue("./StrathE2E/{implementation}/2010-2019/Param/fishing_discards_CELTIC_SEA.csv"))
...
# Setup_file[2,1] <- stringr::str_glue("physics_{toupper(implementation)}_2010-2019-CNRM-ssp126.csv") # Don't need to update as this happens for all variants later
# Setup_file[3,1] <- stringr::str_glue("chemistry_{toupper(implementation)}_2010-2019-CNRM-ssp126.csv")
