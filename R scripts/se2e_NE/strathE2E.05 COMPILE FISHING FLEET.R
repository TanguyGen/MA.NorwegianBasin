...
effort <- t(readRDS("./Data/Fishing_objects_01_25_TG/Data/Norwegian_sea_Tanguy2/Norwegian_sea/2010-2019/Object/International effort by gear.rds"))        # Units sec/m2/day

distribution <- t(readRDS("./Data/Fishing_objects_01_25_TG/Data/Norwegian_sea_Tanguy2/Norwegian_sea/2010-2019/Object/International effort proportion by gear and habitat.rds"))


lookup <- read.csv("./Data/Fishing_objects_01_25_TG/Data/lookup_gear.csv") %>% select(-X) %>% arrange(neworder)  # Import and order tables according to StrathE2E
hablookup <- read.csv("./Data/Fishing_objects_01_25_TG/Data/lookup_habitat.csv") %>% select(-X) %>% arrange(hneworder)
glookup <- read.csv("./Data/Fishing_objects_01_25_TG/Data/lookup_guild.csv") %>% select(-X) %>% arrange(gneworder)


#### quickly copy over Tanguy's fish processing and fleet files ####

processing <- file.copy("./Data/Norwegian_Basin_10_24_TG/Norwegian_Basin/2010-2019-ssp370/Param/fishing_processing_NORWEGIAN_BASIN_2010-2019.csv",
                        str_glue("./StrathE2E/{implementation}/2010-2019/Param/fishing_processing_NORWEGIAN_BASIN_2010-2019.csv"))

fleet <-file.copy("./Data/Norwegian_Basin_10_24_TG/Norwegian_Basin/2010-2019-ssp370/Param/fishing_fleet_NORWEGIAN_BASIN_2010-2019.csv",
                  str_glue("./StrathE2E/{implementation}/2010-2019/Param/fishing_fleet_NORWEGIAN_BASIN_2010-2019.csv"))

mults <- read.csv("./Data/Norwegian_Basin_10_24_TG/Norwegian_Basin/2010-2019-ssp370/Param/fishing_gear_multiplier_NORWEGIAN_BASIN_2010-2019.csv", sep = ",") %>% 
  select(-Gear_code) %>% 
  ...
  write.csv(str_glue("./StrathE2E/{implementation}/2010-2019/Param/fishing_gear_multiplier_{toupper(implementation)}_2010-2019.csv"),row.names=FALSE)
