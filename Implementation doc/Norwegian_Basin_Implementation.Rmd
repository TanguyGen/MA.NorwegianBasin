...
Whole sediment permeability can be related to the proportion of sediment classed as mud (D~50~ < 62 μm) [@pace21]. This relationship was used in the production of the Barents Sea sediment atlas [@laverick2022], which provides the values used in this model implementation (`r table.ref("tab_habitat_proportions")`).
...
To supplement the relationship within the package, predictions of sediment organic nitrogen content for the Norwegian Sea have been sourced from the sediment atlas [@laverick2022] to parameterise StrathE2E directly (`r table.ref("tab_habitat_proportions")`).
